/***************************************************************************
                          commandlineoptions.cpp  -  description
                             -------------------
...
// -------------------------------------------------------------------------------
{
  ...
  if (option=="-e"){
    ...
    std::cout<<"Tuxcards - The Notebook for Linux"<<std::endl
        <<TUX_VERSION<<std::endl
        <<"www.tuxcards.de"<<std::endl
        <<"written by Alexander Theel & Amit Chaudhary"<<std::endl;
    exit(0);
  }else if (option=="-h"){
    printUsage();
    exit(0);
 ...
 */
// -------------------------------------------------------------------------------
void CommandLineOptions::htmlExport(QString fileName)
// -------------------------------------------------------------------------------
{
...
// -------------------------------------------------------------------------------
void CommandLineOptions::htmlExport( QString fileName, QString dirPath )
// -------------------------------------------------------------------------------
{
