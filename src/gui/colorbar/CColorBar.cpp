...
// -------------------------------------------------------------------------------
{
   ...
   f.setBold(true);
   QFontMetrics fm(f);
   textWidth.text1Width = fm.horizontalAdvance( msTextTop );
   textWidth.text2Width = fm.horizontalAdvance( msTextBottom );
...
// -------------------------------------------------------------------------------
{
   ...
   if(msVerticalText!="")
   {
      ...
      int width=fm.horizontalAdvance(msVerticalText);
