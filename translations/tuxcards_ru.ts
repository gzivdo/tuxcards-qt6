...
<context>
    ...
    <message>
        ...
        <translation>Предпросмо&amp;тр печати...</translation>
    </message>
    <message>
    ...
    <message>
        ...
        <translation>Поиск по &amp;дереву...</translation>
    </message>
    <message>
    ...
    <message>
        ...
        <translation>Предпросмотр печати (Ctrl+Shift+P)</translation>
    </message>
    <message>
    ...
    <message>
        ...
        <translation>&lt;b&gt;Предпросмотр печати&lt;/b&gt; (Ctrl+Shift+P)</translation>
    </message>
    <message>
...
%2</source>
        <translation>&lt;em&gt;Экспорт&lt;/em&gt; HTML &lt;font size=-1&gt;(%1)&lt;/font&gt; завершён успешно.
...
(%2)</source>
        <translation>&lt;em&gt;Экспорт&lt;/em&gt; HTML &lt;font size=-1&gt;(%1)&lt;/font&gt; завершился неудачно.

Проверьте права на запись и свободное место
(%2)</translation>
    </message>
    <message>
...
SideBar and PNG icons backported from TuxCards 2.2.1.
        ...
        <translation>TuxCards — Записная книжка для Linux
%1
...
Порт на Qt6 (2026-05-16): Claude Opus 4.7
по инициативе gzivdo (https://github.com/gzivdo)
SideBar и PNG-иконки портированы из TuxCards 2.2.1.
</translation>
    </message>
    <message>
    ...
    <message>
        ...
        <translation>Перед печатью рекомендуется преобразовать эту запись в формат RTF.</translation>
    </message>
    <message>
...
Please download the full build (with both crypto backends) from the project releases page, or rebuild TuxCards with the matching backend enabled.</source>
        <translation>Этот файл зашифрован %1, но эта сборка TuxCards собрана без этого бэкенда.

Скачайте полную сборку (с обоими бэкендами) со страницы релизов проекта или пересоберите TuxCards с нужным бэкендом.</translation>
    </message>
</context>
<context>
